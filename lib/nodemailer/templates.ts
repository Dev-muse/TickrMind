...
<head>
    ...
    <title>Welcome to TickrMind</title>
    <!--[if mso]>
    <noscript>
        <xml>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="left" class="mobile-header-padding" style="padding: 40px 40px 20px 40px;">
                            <img src="https://ik.imagekit.io/Tickrmind/logo-tickrMind.png?updatedAt=1761062765802" alt="TickrMind Logo" width="150" style="max-width: 100%; height: auto;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" class="dashboard-preview" style="padding: 40px 40px 0px 40px;">
                            <img src="https://ik.imagekit.io/Tickrmind/dash-preview.png?updatedAt=1761062765886" alt="TickrMind Dashboard Preview" width="100%" style="max-width: 520px; width: 100%; height: auto; border-radius: 12px; border: 1px solid #30333A;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: 0 0 40px 0; width: 100%;">
                                <tr>
                                    <td align="center">
                                        <a href="https://tickr-mind.vercel.app/" style="display: block; width: 100%; background: linear-gradient(135deg, #FDD458 0%, #E8BA40 100%); color: #000000; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-size: 16px; font-weight: 500; line-height: 1; text-align: center; box-sizing: border-box;">
                                            Go to Dashboard
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p class="mobile-text dark-text-muted" style="margin: 40px 0 0 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important; text-align: center;">
                               TickrMind HQ, Liverpool Rd, London,England, N1 0HZ<br>
                                <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                <a href="https://tickr-mind.vercel.app/" style="color: #CCDADC !important; text-decoration: underline;">Visit TickrMind</a><br>
                                © 2025 TickMind
                            </p>
                        </td>
                    </tr>
                        ...
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    You're receiving this because you subscribed to TickrMind news updates.
                                </p>
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                    <a href="https://TickrMind.app" style="color: #CCDADC !important; text-decoration: underline;">Visit TickrMind</a>
                                </p>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="https://tickr-mind.vercel.app/" style="display: block; width: 100%; max-width: 100%; box-sizing: border-box; color: #000000; background-color: #E8BA40; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-size: 16px; font-weight: 500; line-height: 1; text-align: center;">
                                            View Dashboard
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="https://tickr-mind.vercel.app/" style="display: block; width: 100%; max-width: 100%; box-sizing: border-box; background-color: #E8BA40; color: #000000; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-size: 16px; font-weight: 500; line-height: 1; text-align: center;">
                                            View Dashboard
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="https://tickr-mind.vercel.app/" style="display: inline-block; background-color: #E8BA40; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-size: 16px; font-weight: 500; line-height: 1;">
                                            View Dashboard
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                We noticed you haven't visited TickrMind in a while. The markets have been moving, and there might be some opportunities you don't want to miss!
                            </p>
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                ...
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    ...
                                    <a href="{{dashboardUrl}}" style="color: #CCDADC !important; text-decoration: underline;">Visit TickrMind</a>
                                </p>
                                <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    © 2025 TickrMind
                                </p>
