...
const MenuDropdown = () => {
  ...
  const user = { name: "John Doe", email: "Johndoe@gmail.com" }; // Example user object
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="text-gray-400 " align="start">
        ...
        <DropdownMenuItem onClick={handleSignOut} className="cursor-pointer text-gray-100 text-md font-medium focus: bg-transparent focus:text-yellow-500 transition-all ">
